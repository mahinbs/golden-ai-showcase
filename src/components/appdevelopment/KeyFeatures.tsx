const characterImage =
  "https://res.cloudinary.com/drdjii8fe/image/upload/v1759219707/Below_Title_s8xfuj.png";

const features = [
  {
    img: "https://res.cloudinary.com/drdjii8fe/image/upload/v1759219706/1._Native_Apps_wqwozv.png",
    label: "Native Apps",
    desc: "Fully optimized for iOS and Android devices.",
  },
  {
    img: "https://res.cloudinary.com/drdjii8fe/image/upload/v1759219709/2._Cross-Platform_Apps_cqntwa.png",
    label: "Cross-Platform Apps",
    desc: "Single codebase apps using Flutter or React Native for wider reach.",
  },
  {
    img: "https://res.cloudinary.com/drdjii8fe/image/upload/v1759219705/3._AI-Integrated_Apps_z7t4ty.png",
    label: "AI-Integrated Apps",
    desc: "Smart apps with chatbots, recommendations, and predictive features.",
  },
  {
    img: "https://res.cloudinary.com/drdjii8fe/image/upload/v1759219706/4._IoT-Enabled_Apps_ryqebx.png",
    label: "IoT-Enabled Apps",
    desc: "Connect devices and sensors seamlessly for real-time control and monitoring.",
  },
  {
    img: "https://res.cloudinary.com/drdjii8fe/image/upload/v1759219712/5._ARVR_Apps_s3ucya.png",
    label: "AR/VR Apps",
    desc: "Immersive augmented and virtual reality experiences for training, shopping, and more.",
  },
  {
    img: "https://res.cloudinary.com/drdjii8fe/image/upload/v1759219707/6._Automation_Apps_v8lbzg.png",
    label: "Automation Apps",
    desc: "Automate repetitive business processes to save time and improve efficiency.",
  },
];
          ...
          {showCards ? (
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {features.map(({ label, desc, img }, index) => (
                <div
                  key={index}
                  className="bg-black text-white rounded-2xl p-6 relative shadow-lg"
                >
                  {/* Icon */}
                  ...
                  <div className="pb-4 border-b border-white/70">
                    <div className="bg-yellowClr text-black px-4 py-2 text-sm font-semibold w-fit mx-auto">
                      {label}
                    </div>
                  </div>
