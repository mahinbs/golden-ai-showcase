...
const useScrollTriggerAnimations = () => {
  ...
  useGSAP(
    () => {
      ...
      const toTopLeft = gsap.utils.toArray(".toTopLeft") as HTMLElement[];
      ...
      const toRight = gsap.utils.toArray(".toBottomRight") as HTMLElement[];
      toRight.forEach((box) => {
        gsap.fromTo(
          box,
          { x: -100 },
      ...
      const fromLeftToTopRight = gsap.utils.toArray(".fromLeftToTopRight") as HTMLElement[];
      gsap.fromTo(
        fromLeftToTopRight,
        { y: 400, x: -400 },
        {
