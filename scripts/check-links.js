// Simple link checker for portfolioData.ts
// Usage:
//   node scripts/check-links.js            -> only report
//   node scripts/check-links.js --write    -> replace broken links with "#"
...
async function checkUrl(url) {
  ...
  try {
    ...
    // Some servers block HEAD or redirect oddly; try GET
